"""
Deepgram STT adapter using raw websockets.
...
class DeepgramSTTAdapter(STTProviderInterface):
    ...
    Credentials and STT URL are injected at construction — no settings import.
    """

    def __init__(self, api_key: str, stt_url: str):
